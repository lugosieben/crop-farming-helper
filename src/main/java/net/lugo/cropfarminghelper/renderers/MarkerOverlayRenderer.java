package net.lugo.cropfarminghelper.renderers;
...
public class MarkerOverlayRenderer extends OverlayRenderer {
    private static final Identifier MARKER_TEXTURE = Identifier.fromNamespaceAndPath(CropFarmingHelper.MOD_ID, "textures/marker.png");
